...
execute_process(
  COMMAND "/usr/bin/git" show-ref "0d859a811870d10f53a594927d0d0b97573ad06d"
  WORKING_DIRECTORY "/home/jiahuan/MLsys/tflite_build/farmhash"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/jiahuan/MLsys/tflite_build/farmhash'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/jiahuan/MLsys/tflite_build/farmhash'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
