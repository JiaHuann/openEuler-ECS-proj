...
execute_process(
  COMMAND "/usr/bin/git" show-ref "3286a34cc8de6149ac6844107dfdffac91531e72"
  WORKING_DIRECTORY "/home/jiahuan/MLsys/tflite_build/ruy"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/jiahuan/MLsys/tflite_build/ruy'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/jiahuan/MLsys/tflite_build/ruy'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
