...
execute_process(
  COMMAND "/usr/bin/git" show-ref "5b9fc9ad978757654843f4a8d899715dbea30e88"
  WORKING_DIRECTORY "/home/jiahuan/MLsys/tflite_build/ml_dtypes"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "5b9fc9ad978757654843f4a8d899715dbea30e88")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("5b9fc9ad978757654843f4a8d899715dbea30e88" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/5b9fc9ad978757654843f4a8d899715dbea30e88")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/jiahuan/MLsys/tflite_build/ml_dtypes'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/jiahuan/MLsys/tflite_build/ml_dtypes'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
