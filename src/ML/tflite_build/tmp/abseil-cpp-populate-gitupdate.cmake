...
execute_process(
  COMMAND "/usr/bin/git" show-ref "b971ac5250ea8de900eae9f95e06548d14cd95fe"
  WORKING_DIRECTORY "/home/jiahuan/MLsys/tflite_build/abseil-cpp"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/jiahuan/MLsys/tflite_build/abseil-cpp'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/jiahuan/MLsys/tflite_build/abseil-cpp'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
