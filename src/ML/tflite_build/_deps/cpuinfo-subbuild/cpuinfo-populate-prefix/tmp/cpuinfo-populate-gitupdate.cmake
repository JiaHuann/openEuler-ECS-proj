...
execute_process(
  COMMAND "/usr/bin/git" show-ref "959002f82d7962a473d8bf301845f2af720e0aa4"
  WORKING_DIRECTORY "/home/jiahuan/MLsys/tflite_build/cpuinfo"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "959002f82d7962a473d8bf301845f2af720e0aa4")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("959002f82d7962a473d8bf301845f2af720e0aa4" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/959002f82d7962a473d8bf301845f2af720e0aa4")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/jiahuan/MLsys/tflite_build/cpuinfo'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/jiahuan/MLsys/tflite_build/cpuinfo'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
